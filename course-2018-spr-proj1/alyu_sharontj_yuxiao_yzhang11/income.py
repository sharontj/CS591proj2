...
class income(dml.Algorithm):
    ...
    reads = []
    writes = ['alyu_sharontj_yuxiao_yzhang11.income']
    ...
    def execute(trial = True):
        ...
        repo['alyu_sharontj_yuxiao_yzhang11.medianIncome'].insert_many(raw)
        repo['alyu_sharontj_yuxiao_yzhang11.medianIncome'].metadata({'complete':True})
        print(repo['alyu_sharontj_yuxiao_yzhang11.medianIncome'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:alyu_sharontj_yuxiao_yzhang11#income', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        output = doc.entity('dat:alyu_sharontj_yuxiao_yzhang11.medianIncome', {prov.model.PROV_LABEL:'medianIncome', prov.model.PROV_TYPE:'ont:DataSet'})
