...
class zriRentPrice(dml.Algorithm):
    ...
    def execute(trial=True):
        ...
        repo['yuxiao_yzhang11.rental'].insert_many(dict_values)
    ...
    def provenance(doc=prov.model.ProvDocument(), startTime=None, endTime=None):
        ...
        this_script = doc.agent('alg:yuxiao_yzhang11#zriRentPrice',
        ...
        output =  doc.entity('dat:yuxiao_yzhang11.rental', {prov.model.PROV_LABEL:'rental', prov.model.PROV_TYPE:'ont:DataSet'})
